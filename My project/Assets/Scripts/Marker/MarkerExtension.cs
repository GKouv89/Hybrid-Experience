...
namespace DIMuseumVR.Marker
{
    public class MarkerExtension : GrabbableEvents
    {
        ...
        private Color initialMarkerColor;
        private Vector3 initialMarkerPosition;
        private Quaternion initialMarkerRotation;
        private List<Transform> lines = new List<Transform>();
        public Vector3Event onJoystickVectorChange;
        ...
        /// Extender public methods for marker and drawing handling
        ...
        public void ResetMarkerPosition()
        {
            if (!grabbable.BeingHeld)
            {
                ...
                transform.position = initialMarkerPosition;
                transform.rotation = initialMarkerRotation;
            }
        }
        ...
        {
            DrawColor = Color.red;
            markerRenderer.sharedMaterial.color = Color.red;
        }
        public void SetGreen()
        {
            DrawColor = Color.green;
            markerRenderer.sharedMaterial.color = Color.green;
        }
        public void SetBlue()
        {
            DrawColor = Color.blue;
            markerRenderer.sharedMaterial.color = Color.blue;
        }
        ...
        /// Material Init & Cleanup (we use sharedMaterial so no new material instances will be generated in run-time)
        private void Start()
        {
            initialMarkerColor = markerRenderer.sharedMaterial.color;
            initialMarkerPosition = gameObject.transform.position;
            initialMarkerRotation = gameObject.transform.rotation;
        ...
        {
            markerRenderer.sharedMaterial.color = initialMarkerColor;
        }
    }
}
