    ...
    public class NetworkedGrabbable : Grabbable, IPunObservable {
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info) {
            ...
            // Receive Updates
                ...
                isInBag = (bool)stream.ReceiveNext();
        ...
        public void MoveObject(Vector3 pos, Quaternion rot)
        {
            // Check if owner has left or is unassigned
            CheckForNullOwner();
            
            // Our object
            //else if (view.IsMine)         // This was already checked before the function call, in the Bandu script
            {
                isInBag = false;
        ...
        public void MoveObjectRPC(Vector3 pos, Quaternion rot, PhotonMessageInfo info)
        {
